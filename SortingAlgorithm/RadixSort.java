...
// Referensi: https://www.geeksforgeeks.org/radix-sort/

/*
  Implementasi visualisasi algoritma Radix Sort menggunakan GUI.
  Algoritma Radix Sort adalah algoritma pengurutan yang mengurutkan angka berdasarkan digit-digitnya,
  dari digit paling rendah (LSB) ke digit paling tinggi (MSB).
  Proses pengurutan dilakukan dengan menggunakan counting sort pada setiap digit, mulai dari digit terendah hingga digit tertinggi.
  Kompleksitas waktu rata-rata dari Radix Sort adalah O(nk), dengan n adalah jumlah elemen dalam array
  dan k adalah jumlah digit maksimum dalam elemen-elemen array.
 */
import javax.swing.*;
import java.awt.*;
